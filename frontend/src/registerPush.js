export async function registerPush() {
  ...
  try {
    ...
    const DIRECT_VAPID_KEY = 'BPaSiaEDBPZ5-sxFuEeJvaheaqSDwlIRJZqdUVycYeycUBuVVM4LjLFa6YbRL3uaipiTm7ykE2eRbn0dtG7Vdbg';
    ...
    if (!DIRECT_VAPID_KEY) {
      try {
        console.log(`Intentando obtener clave VAPID de ${API_URL}/api/push/public-key`);
    ...
    try {
      ...
      try {
        ...
        if (res.ok) {
          ...
          console.error('Error al enviar suscripción al backend:', errorMessage);
      ...
      return { success: true, message: 'Notificaciones configuradas correctamente' };
    } catch (error) {
